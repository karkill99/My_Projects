...
def contact():
    mess._show(title='Contact us',
               message="Please contact us on : 'kartikmm99@gmail.com' ")
...
window.title(
    "Face Recognition Based Attendance Monitoring System - Developed By Kartik")
window.configure(background='seashell3')
...
message3 = tk.Label(window, text="Face Recognition Based Attendance Monitoring System", justify='center',
                    fg="white", bg="#49A", width=55, height=2, font=('comic', 29, ' bold '))
message3.place(x=0, y=0, relwidth=1)

frame3 = tk.Frame(window, bg="#c4c6ce")
frame3.place(relx=0.52, rely=0.09, relwidth=0.09, relheight=0.05)

frame4 = tk.Frame(window, bg="#c4c6ce")
frame4.place(relx=0.36, rely=0.09, relwidth=0.16, relheight=0.05)

datef = tk.Label(frame4, text=day+""+mont[month]+"-"+year+"  | ", fg="white",
                 bg="#49A", width=55, height=1, font=('comic', 22, ' bold '))
datef.pack(fill='both', expand=1)

clock = tk.Label(frame3, fg="white", bg="#49A", width=55,
                 height=1, font=('comic', 22, ' bold '))
clock.pack(fill='both', expand=1)
tick()

head2 = tk.Label(frame2, text="                       For New Registrations                       ",
                 fg="black", bg="dodger blue", font=('comic', 17, ' bold '))
...
trainImg = tk.Button(frame2, text="Save Profile", command=psw, fg="white", bg="violet red",
                     width=34, height=1, activebackground="white", font=('comic', 15, ' bold '))
...
quitWindow = tk.Button(frame1, text="Quit", command=window.destroy, fg="black", bg="deep sky blue",
