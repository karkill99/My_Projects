...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'kartikmalbhage99@gmail.com' ")
...
window.title("Face Recognition Based Attendance Monitoring System - Developed By Kartik M.")
